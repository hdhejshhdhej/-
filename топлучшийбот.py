...
def check_user_id_for_twin(user_id):
    ...
    # Если ID начинается с 75 или больше (например, 750000000, 760000000 и т.д.)
    # Это примерный порог для новых аккаунтов
    # Вы можете изменить логику проверки по своему усмотрению
